...
VM_PREFIX = Vifid_stage
# Module prefix (from --prefix)
VM_MODPREFIX = Vifid_stage
...
include Vifid_stage_classes.mk
...
ifid_stage_test.o: ../tests/ifid_stage_test.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
Vifid_stage: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
