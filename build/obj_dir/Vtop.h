...
VL_MODULE(Vtop) {
  public:
	...
	VL_SIG8(top__DOT__cpu__DOT__id_exc_addr_if,0,0);
	...
	VL_SIG8(top__DOT__cpu__DOT__ex_bad_jump_addr,0,0);
	VL_SIG8(top__DOT__cpu__DOT__ex_bad_branch_addr,0,0);
	...
	VL_SIG8(top__DOT__cpu__DOT__ex_exc_addr_if,0,0);
	...
	VL_SIG8(top__DOT__cpu__DOT__mem_exc_addr_if,0,0);
	VL_SIG8(top__DOT__cpu__DOT__mem_inst_access_fault,0,0);
	VL_SIG8(top__DOT__cpu__DOT__mem_bad_jump_addr,0,0);
	VL_SIG8(top__DOT__cpu__DOT__mem_bad_branch_addr,0,0);
	...
	VL_SIG8(top__DOT__cpu__DOT__wb_exc_addr_if,0,0);
	VL_SIG8(top__DOT__cpu__DOT__wb_inst_access_fault,0,0);
	VL_SIG8(top__DOT__cpu__DOT__wb_mem_access_fault,0,0);
	VL_SIG8(top__DOT__cpu__DOT__wb_bad_jump_addr,0,0);
	VL_SIG8(top__DOT__cpu__DOT__wb_bad_branch_addr,0,0);
	...
	VL_SIG8(top__DOT__cpu__DOT__wb_ret_op,0,0);
	...
	VL_SIG8(top__DOT__cpu__DOT__trap_valid,0,0);
	VL_SIG8(top__DOT__cpu__DOT__exception_code,3,0);
	VL_SIG8(top__DOT__cpu__DOT__interrupt_code,0,0);
	VL_SIG8(top__DOT__cpu__DOT__intruction_ret,0,0);
	...
	VL_SIG8(top__DOT__cpu__DOT__CSR__DOT__is_mscratch,0,0);
	...
	VL_SIG(top__DOT__dwbm_addr,31,0);
	...
	VL_SIG(top__DOT__cpu__DOT__ID__DOT__drs1,31,0);
	...
	VL_SIG(top__DOT__cpu__DOT__LSU__DOT__rdata,31,0);
    ...
    VL_SIG8(top__DOT__cpu__DOT____Vcellinp__EX__ex_flush_i,0,0);
    VL_SIG8(__Vdly__top__DOT__cpu__DOT__mem_mem_flags,5,0);
    VL_SIG8(__VinpClk__TOP__top__DOT__dwbm_cyc,0,0);
    VL_SIG8(__Vclklast__TOP__clk_i,0,0);
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__top__DOT__dwbm_cyc,0,0);
    VL_SIG8(__Vchglast__TOP__top__DOT__dwbm_cyc,0,0);
